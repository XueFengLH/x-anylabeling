...
from .images_pixel_to_7 import process_images_in_directory
import imgviz
import natsort
import numpy as np
...
class LabelingWidget(LabelDialog):
    ...
    def export_mask_annotation(self, _value=False, dirpath=None):
        ...
        filter = "JSON Files (*.json);;All Files (*)"
        color_map_file = '/mnt/sda2/code/X-AnyLabeling-main/anylabeling/views/labeling/mask_grayscale_map.json'
        # output_path = QtWidgets.QFileDialog.getOpenFileName(
        #     self,
        #     self.tr("Select a output path"),
        #     "",
        #     filter,
        # )
        ...
        label_path = output_path + '/output/train_data/gtFine/train/wire'
        mask_path = output_path + '/output/train_data/gtFine/train/mask'
        img_path = output_path + '/output/train_data/leftImg8bit/train/wire'
        ...
        try:
            ...
            msg_box.setWindowTitle(self.tr("Success"))
            msg_box.exec_()
            process_images_in_directory(mask_path)
